...
function BusHelperSignup() {
  ...
  // Shared class for both inputs and select boxes to ensure they look identical
      ...
      <div className="max-w-2xl w-full space-y-8 bg-white p-10 rounded-xl shadow-lg border border-gray-100">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Register a new helper and assign them to a school/bus
          </p>
        </div>
        ...
        <div className="mt-8 space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <select name="busId" className={inputClass} onChange={handleChange}>
